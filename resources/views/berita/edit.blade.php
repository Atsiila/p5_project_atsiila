                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_penulis" id="" class="form-control">
                                @foreach ($penulis as $item)
                                    <option value="{{$item->id}}" {{$item->id == $berita->id_penulis ? 'selected': ''}}>{{ $item->nama_merek }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <select name="id_kategori" id="" class="form-control">
                                @foreach ($kategori as $item)
                                    <option value="{{$item->id}}" {{$item->id == $berita->id_kategori ? 'selected': ''}}>{{ $item->nama_merek }}</option>
                                @endforeach
                            </select>
                        </div>
